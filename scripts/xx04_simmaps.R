...
#### Use simmap to map regimes onto tree, save simmap tree
Fly <- setNames(ModelDat$flight, ModelDat$species)

#### Load simmap tree, use OUwie to fit BMS and various OU models
strees <- make.simmap(Tree, Fly, model = "ARD", pi = setNames(c(0, 1), c("0","1")), nsim=1e2, Q="mcmc")
